...
if __name__ == "__main__":
    ...
    train_iterator = _RawTextIterableDataset(NUM_LINES['train'], 300000, _create_data_from_csv(args.train_path))
    dev_iterator = _RawTextIterableDataset(NUM_LINES['dev'], 37500, _create_data_from_csv(args.dev_path))
